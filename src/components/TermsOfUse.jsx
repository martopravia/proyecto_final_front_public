    ...
    <div className="modal-backdrop">
      <div className="modal-content ">
        ...
        <p>
          ...
          we do not guarantee that product descriptions, prices, or other
          content are complete, reliable, current, or error-free. We reserve the
          right to correct any errors and update information at any time without
          prior notice.
        </p>
        ...
        <p>
          ...
          use or inability to use this website or the products purchased through
          it.
        </p>
